...
public class GymLogRepository {
    ...
    public static GymLogRepository getRepository(Application application) {
        ...
        try {
            ...
            Log.i(MainActivity.TAG, "Problem getting gym log repository error");
        }
    ...
    public ArrayList<GymLog> getAllLogs() {
        ...
        try {
            ...
            Log.i(MainActivity.TAG, "Problem when getting all the gym logs in the repository");
        }
        return null;
    }
    ...
    public User getUserByUsername(String username) {
        ...
        try {
            ...
            Log.i(MainActivity.TAG, "Problem while getting all gym logs from the repository.");
        }
